...
if (isset($_SESSION['userid'])) {
    ...
    // Lanjutkan dengan operasi yang membutuhkan $userid
} else {
    // Sesuaikan tindakan sesuai dengan logika aplikasi Anda
    echo "Session 'userid' tidak tersedia.";
}
...
<body>
    ...
    <footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
        <p>&copy; UKK PPLG 2024 | NAURA AQILA NURUDDIA</p>
    </footer>
